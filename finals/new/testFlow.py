...
df2 = load(NROWS=100000)
wanted = [row for _,row in df.iterrows() if row.lengths <= 61 and row.lengths <7]
...
"""
#full model per bin
(0.8430594900849858, 10846, 1793, 7010, 1531, 0.8763028197463036, 0.8581375108790252, 0.8671250399744165) 
(0.840058910162003, 8680, 1569, 8432, 1689, 0.8371106181888321, 0.8469118938433018, 0.8419827335338055) 
(0.8046250806411592, 7376, 1691, 8838, 2246, 0.7665765953024319, 0.8134995036947171, 0.7893413237733425) 
(0.817079207920792, 7848, 1901, 8657, 1794, 0.8139390168014935, 0.8050056416042671, 0.8094476819142903) 
(0.802530526548428, 6962, 1967, 7563, 1607, 0.8124635313338779, 0.779706574084444, 0.7957480854954853)
"""
